...
export class SwapUsdtWorkNetProvider implements IContractProvider {
  private readonly onEventCallBacks: onEventCallBack[] = [];

  private readonly preParsingSteps = 6000;

  constructor (
    public readonly clients: SwapUsdtWorkNetClients,
  ...
  public async startListener() {
    ...
    Logger.info('Start SwapUsdt listener on contract: "%s"', this.contract.options.address);
  }
