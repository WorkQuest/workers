...
export class WqtWethRpcProvider implements IContractProvider {
...
export class WqtWethWsProvider extends WqtWethRpcProvider implements IContractListenerProvider {
